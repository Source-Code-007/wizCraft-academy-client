        ...
        <div className="min-h-screen bg-slate-800 bg-blend-overlay bg-center bg-cover" style={{ backgroundImage: `url(${bgImg})` }}>
            {
                (user?.email && isLoading) ? <div className="h-screen flex items-center justify-center">
                    <ThreeCircles
                        ...
                        middleCircleColor=""
                    /> </div>
                    : !paymentInfo?.length ? <div className="h-screen flex items-center justify-center"><h2 className='text-4xl text-white font-bold bg-red-500 p-3'>There are no payment history!</h2></div>
