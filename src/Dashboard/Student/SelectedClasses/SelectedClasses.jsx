        ...
        <div className='min-h-screen bg-center bg-cover bg-slate-900 bg-blend-overlay' style={{ backgroundImage: `url(${bgImg})` }}>
            {
                selectedClassesIsLoading ? <div className="h-screen flex items-center justify-center">
                    <ThreeCircles
                        ...
                        middleCircleColor=""
                    /> </div>
                    : !selectedClasses.length ? <div className="h-screen flex items-center justify-center"><h2 className='text-4xl text-white font-bold bg-red-500 p-3'>There are no selected classes!</h2></div>
