            ...
            <div className='grid grid-cols-12 gap-7'>
                <div className='col-span-12 lg:col-span-3 flex flex-col gap-7'>
                    <div className="relative group !h-[500px] md:!h-full overflow-hidden">
                        <img src={galleryImg1} className="h-full w-full object-cover transform group-hover:scale-105 transition duration-500" alt="" />
                    ...
                    <div className="relative group !h-[500px] md:!h-full overflow-hidden">
                        <img src={galleryImg3} className="h-full w-full object-cover transform group-hover:scale-105 transition duration-500" alt="" />
                        <div className="absolute top-0 left-0 w-full h-full bg-black opacity-0 transition-opacity duration-300 hover:opacity-50"></div>
                    </div>
                </div>
                <div className='col-span-12 lg:col-span-6'>
                    <div className="relative group !h-[500px] md:!h-full overflow-hidden">
                        <img src={galleryImg2} className="h-full w-full object-cover transform group-hover:scale-105 transition duration-500" alt="" />
                        <div className="absolute top-0 left-0 w-full h-full bg-black opacity-0 transition-opacity duration-300 hover:opacity-50"></div>
                    </div>
                </div>
                <div className='col-span-12 lg:col-span-3'>
                    <div className="relative group  !h-[500px] md:!h-full overflow-hidden">
                        <img src={galleryImg4} className="h-full w-full object-cover transform group-hover:scale-105 transition duration-500" alt="" />
                        <div className="absolute top-0 left-0 w-full h-full bg-black opacity-0 transition-opacity duration-300 hover:opacity-50"></div>
                    </div>
                </div>
            </div>
